...
namespace THUMDER.Interpreter
{
    public static partial class Assembler
    {
        ...
        public readonly static Instruction[] OpCodes = new Instruction[]
        {
            ...
            new Instruction ( "movs2i",   0x00000031,   "c,a"   ),  /* Move to special register     */
            new Instruction ( "movf",     0x00000032,   "c,a"   ),  /* Move from special register   */
            new Instruction ( "movd",     0x00000033,   "c,a"   ),  /* Move from special register   */
            new Instruction ( "movfp2i",  0x00000034,   "c,a"   ),  /* Move from special register   */
            new Instruction ( "movi2fp",  0x00000035,   "c,a"   ),  /* Move from special register   */
            
            /* FPU R-TYPE instructions.  */
            new Instruction ( "addf",     0x04000000,   "c,a,b" ),  /* Sub Unsigned                 */
            new Instruction ( "subf",     0x04000001,   "c,a,b" ),  /* Sub Unsigned                 */
            new Instruction ( "multf",    0x04000002,   "c,a,b" ),  /* MULTIPLY                     */
            new Instruction ( "divf",     0x04000003,   "c,a,b" ),  /* MULTIPLY Unsigned            */
            new Instruction ( "addd",     0x04000004,   "c,a,b" ),  /* DIVIDE                       */
            new Instruction ( "subd",     0x04000005,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "multd",    0x04000006,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "divd",     0x04000007,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvtf2d",   0x04000008,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvtf2i",   0x04000009,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvtd2f",   0x0400000A,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvtd2i",   0x0400000B,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvti2f",   0x0400000C,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "cvti2d",   0x0400000D,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "mult",     0x0400000E,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "div",      0x0400000F,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "eqf",      0x04000010,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "nef",      0x04000011,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "ltf",      0x04000012,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "lgf",      0x04000013,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "lef",      0x04000014,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "gef",      0x04000015,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "multu",    0x04000016,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "divu",     0x04000017,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "eqd",      0x04000018,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "ned",      0x04000019,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "ltd",      0x0400001A,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "gtd",      0x0400001B,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "led",      0x0400001C,   "c,a,b" ),  /* DIVIDE Unsigned              */
            new Instruction ( "ged",      0x0400001D,   "c,a,b" ),  /* DIVIDE Unsigned              */
